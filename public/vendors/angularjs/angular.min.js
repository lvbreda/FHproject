...
(function (X, Y, q) {
    ...
    function U(b, a) {
        ...
        if (a) {
            ...
            if (B(b))for (var c = a.length = 0; c < b.length; c++)a.push(U(b[c])); else for (c in n(a, function (b, c) {
                delete a[c]
            }), b)a[c] = U(b[c])
    ...
    function Va(b) {
        b && b.length !==
            0 ? (b = y("" + b), b = !(b == "f" || b == "0" || b == "false" || b == "no" || b == "n" || b == "[]")) : b = !1;
        return b
    }
            ...
            "module", function () {
                ...
                return function (d, e, g) {
                    ...
                    return a(b, d, function () {
                        ...
                        var b = [], c = [], i = a("$injector", "invoke"), k = {_invokeQueue:b, _runBlocks:c, requires:e, name:d, provider:a("$provide", "provider"), factory:a("$provide", "factory"), service:a("$provide", "service"), value:a("$provide", "value"), constant:a("$provide", "constant", "unshift"), filter:a("$filterProvider",
                            "register"), controller:a("$controllerProvider", "register"), directive:a("$compileProvider", "directive"), config:i, run:function (a) {
                            c.push(a);
                            return this
                        }};
                        g && i(g);
    ...
    function ba(b, a, c) {
        var d = b[Ba], d = Ca[d || -1];
        if (x(c))d || (b[Ba] = d = ++oc, d = Ca[d] = {}), d[a] = c; else return d && d[a]
    }

    function vb(b, a, c) {
        var d = ba(b, "data"), e = x(c), g = !e && x(a), h = g && !M(a);
        !d && !h && ba(b, "data", d = {});
    ...
    function rb(b) {
        function a(a) {
            return function (b, c) {
                if (M(b))n(b, nb(a)); else return a(b, c)
            }
        }
                ...
                if (!i.get(a))if (i.put(a, !0), A(a)) {
                    ...
                    try {
                        for (var d = c._invokeQueue, c = 0, f = d.length; c < f; c++) {
                            var g = d[c], h = g[0] == "$injector" ? m : m.get(g[0]);
                            h[g[1]].apply(h, g[2])
                        }
                    } catch (j) {
    ...
    function uc() {
        ...
        this.$get = ["$window", "$location", "$rootScope", function (a, c, d) {
            ...
            function g() {
                var b = c.hash(), d;
                b ? (d = h.getElementById(b)) ? d.scrollIntoView() : (d = e(h.getElementsByName(b))) ? d.scrollIntoView() : b === "top" && a.scrollTo(0, 0) :
                    a.scrollTo(0, 0)
            }
    ...
    function vc(b, a, c, d) {
        ...
        f.onUrlChange = function (a) {
            K || (d.history && u(b).bind("popstate",
                h), d.hashchange ? u(b).bind("hashchange", h) : f.addPollFn(h), K = !0);
            V.push(a);
            return a
        };
        f.baseHref = function () {
        ...
        f.cookies = function (a, b) {
            var d, e, f, i;
            if (a)if (b === q)j.cookie = escape(a) + "=;path=" + P + ";expires=Thu, 01 Jan 1970 00:00:00 GMT"; else {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", function (b, i, k, m, l, t, o, p, s) {
            ...
            function V(a, b, c, i) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        var j, k, l;
                        h = a.attributes;
                        for (var o = 0, m = h && h.length; o < m; o++)if (j = h[o], j.specified)k = j.name, l = ea(k.toLowerCase()), g[l] = k, c[l] = j = O(Z && k == "href" ? decodeURIComponent(a.getAttribute(k, 2)) :
                            j.value), zb(a, l) && (c[l] = !0), R(a, b, j, l), r(b, l, "A", i);
                        a = a.className;
            ...
            function K(a, b, c, d, e) {
                ...
                function h(a, b) {
                    ...
                    if (A(a)) {
                        for (; (c = a.charAt(0)) == "^" || c == "?";)a =
                            a.substr(1), c == "^" && (d = "inheritedData"), e = e || c == "?";
                        c = b[d]("$" + a + "Controller");
                ...
                function j(a, d, e, i, g) {
                    ...
                    p = l.$$element;
                    if (K) {
                        var J = /^\s*([@=&])\s*(\w*)\s*$/, ja = d.$parent || d;
                        n(K.scope, function (a, b) {
                            var c = a.match(J) || [], e = c[2] || b, c = c[1], i, g, h;
                ...
                for (var l = -Number.MAX_VALUE, m = [], s = [], p = null, K = null, z = null, D = c.$$element = u(b), r, G, S, ka, R = d, x, w, W, v = 0, y = a.length; v < y; v++) {
                    ...
                    G = r.name;
                    if (W = r.controller)x = x || {},
                        ua("'" + G + "' controller", x[G], r, D), x[G] = r;
                    ...
                    if (r.templateUrl)ua("template", z, r, D), z = r, j = P(a.splice(v, a.length - v), j, D, c, e, r.replace, R), y = a.length; else if (r.compile)try {
            ...
            var D = s[0].createElement("a"),
                S = i.startSymbol(), ka = i.endSymbol(), Eb = S == "{{" || ka == "}}" ? na : function (a) {
    ...
    function wa(b, a) {
        var c = Gb.exec(b), c = {protocol:c[1], host:c[3], port:E(c[5]) || Hb[c[1]] || null, path:c[6] || "/", search:c[8],
            hash:c[10]};
    ...
    function Ha(b, a, c) {
        ...
        this.$$compose = function () {
            var b = pb(this.$$search), c = this.$$hash ? "#" + Ya(this.$$hash) : "";
            this.$$url = Fb(this.$$path) + (b ? "?" + b : "") + c;
    ...
    function Ic() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, g) {
            ...
            a ? (j =
                d.baseHref() || "/", i = j.substr(0, j.lastIndexOf("/")), m = la(m.protocol, m.host, m.port) + i + "/", f = e.history ? new hb(Fc(k, j, b), i, m) : new Ib(Gc(k, j, b), b, m, j.substr(i.length + 1))) : (m = la(m.protocol, m.host, m.port) + (m.path || "") + (m.search ? "?" + m.search : "") + "#" + b + "/", f = new Ha(k, b, m));
    ...
    function Kc(b, a) {
        ...
        function i() {
            for (var a = "", c = o; o < b.length;) {
                ...
                if (i == "." ||
                    e(i))a += i; else {
                    var g = d();
                    if (i == "e" && f(g))a += i; else if (f(i) && g && e(g) && a.charAt(a.length - 1) == "e")a += i; else if (f(i) && (!g || !e(g)) && a.charAt(a.length - 1) == "e")j("Invalid exponent"); else break
                }
                o++
            }
            a *= 1;
        ...
        for (var l = [], t, o = 0, p = [], s, J = ":"; o < b.length;) {
            ...
            } else if (c("(){}[].,;:"))l.push({index:o, text:s, json:":[,".indexOf(J) != -1 && c("{[") || c("}]:,")}), c("{[") && p.unshift(s), c("}]") && p.shift(), o++; else if (g(s)) {
                o++;
                continue
            } else {
                var n = s + d(), z = Ja[s], V = Ja[n];
                V ? (l.push({index:o, text:n, fn:V}), o += 2) : z ? (l.push({index:o, text:s, fn:z, json:"[,:".indexOf(J) != -1 && c("+-")}), o += 1) : j("Unexpected next character ", o, o + 1)
            }
            J = s
        }
        return l
    ...
    function Mc(b, a, c, d) {
        ...
        function z() {
            var a;
            if (f("("))a = w(), j(")"); else if (f("["))a = V(); else if (f("{"))a = K(); else {
                var b = f();
        ...
        var r = I(0), $, P = Kc(b, d), G = function () {
            var a = t(), c, d;
            return(d = f("=")) ? (a.assign || e("implies assignment but [" + b.substring(0, d.index) +
                "] can not be assigned to", d), c = t(), function (b, d) {
            ...
            for (var a = G(), b; ;)if (b = f("|"))a = k(a, b.fn, l()); else return a
        };
    ...
    function Kb(b, a) {
        ...
        if (a)e = d < 6 ? Mb(c[0], c[1], c[2], c[3], c[4]) : function (a, b) {
            var e = 0, i;
            do i = Mb(c[e++], c[e++], c[e++], c[e++], c[e++])(a, b), b = q,
                a = i; while (e < d);
            return i
        }; else {
            var g = "var l, fn, p;\n";
            ...
            function i() {
                ...
                if (b && i && b.$route === i.$route && ga(b.pathParams, i.pathParams) && !b.reloadOnSearch && !l)i.params = b.params, U(i.params, d), a.$broadcast("$routeUpdate", i); else if (b || i)l = !1, a.$broadcast("$routeChangeStart", b, i), (t.current = b) && b.redirectTo && (A(b.redirectTo) ? c.path(m(b.redirectTo, b.params)).search(b.params).replace() : c.url(b.redirectTo(b.pathParams, c.path(), c.search())).replace()), e.when(b).then(function () {
                    if (b) {
                        ...
                        if (!x(d = b.template))if (x(d = b.templateUrl))d = h.get(d, {cache:f}).then(function (a) {
                            return a.data
                        });
    ...
    function Sc() {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", function (a, c, d) {
            ...
            e.prototype = {$new:function (a) {
                ...
                }, defaultPrevented:!1}, j = [h].concat(ha.call(arguments, 1)), n, q;
                do {
                    e = f.$$listeners[a] || d;
                    h.currentScope = f;
                    n = 0;
    ...
    function Tc() {
        this.$get =
            ["$window", function (b) {
                var a = {}, c = E((/android (\d+)/.exec(y(b.navigator.userAgent)) || [])[1]);
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, j, i, k) {
            function m(a) {
                ...
                var e = a.transformRequest ||
                    d.transformRequest, f = a.transformResponse || d.transformResponse, g = d.headers, g = v({"X-XSRF-TOKEN":b.cookies()["XSRF-TOKEN"]}, g.common, g[y(a.method)], a.headers), e = Pb(a.data, Ob(g), e), j;
            ...
            function l(b, c, d) {
                ...
                if (n)if (p = n.get(q))if (p.then)return p.then(h, h), p; else B(p) ? f(p[1], p[0], U(p[2])) : f(p, 200, {}); else n.put(q, l);
                p || a(b.method,
        ...
        return function (e, j, i, k, m, l, t) {
            ...
            if (y(e) == "jsonp") {
                ...
                s.onreadystatechange = function () {
                    if (s.readyState == 4) {
                        var a = s.getAllResponseHeaders(), b = ["Cache-Control", "Content-Language", "Content-Type", "Expires", "Last-Modified", "Pragma"];
                        a || (a = "", n(b, function (b) {
    ...
    function $c() {
        this.$get = ["$rootScope", "$browser", "$q", "$exceptionHandler", function (b, a, c, d) {
            function e(e, f, j) {
                var i = c.defer(), k = i.promise, m = x(j) && !j, f = a.defer(function () {
                    try {
                        i.resolve(e())
                    } catch (a) {
                        i.reject(a), d(a)
    ...
    function Rb(b) {
        ...
        return function (b, d) {
            ...
            return Vb(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(/\u00A4/g,
                d)
        }
    }
    ...
    function Vb(b, a, c, d, e) {
        ...
        if (!i) {
            ...
            var h = Math.pow(10, e), b = Math.round(b * h) / h, b = ("" + b).split(Wb), h = b[0], b = b[1] || "", i = 0, k = a.lgSize,
                m = a.gSize;
    ...
    function Sb(b) {
        ...
        return function (c, e) {
            var g =
                "", h = [], f, j, e = e || "mediumDate", e = b.DATETIME_FORMATS[e] || e;
        ...
        return function (a, c, d) {
            ...
            for (var c = B(c) ? c : [c], c = Sa(c, function (a) {
                ...
                return e(function (a, b) {
                    ...
                    f == g ? (f == "string" && (c = c.toLowerCase()), f ==
                        "string" && (e = e.toLowerCase()), c = c === e ? 0 : c < e ? -1 : 1) : c = f < g ? -1 : 1;
                    return c
                }, c)
    ...
    function Xb(b, a) {
        ...
        d.$setValidity = function (a, b, i) {
            ...
            if (b) {
                ...
                if (k) {
                    if (Aa(k, i) != -1)return
                } else h[a] = k = [], g++, c(!1, a), e.$setValidity(a, !1,
                    d);
                k.push(i);
                d.$valid = !1;
                d.$invalid = !0
    ...
    function Pa(b, a, c, d, e, g) {
        ...
        if (c.ngMaxlength) {
            var m = E(c.ngMaxlength), c = function (a) {
    ...
    var y = function (b) {
        ...
        }, Z = E((/msie (\d+)/.exec(y(navigator.userAgent)) || [])[1]), u, ca, ha = [].slice, Qa = [].push, xa = Object.prototype.toString,
        Zb = X.angular || (X.angular = {}), ta, fb, aa = ["0", "0", "0"];
    C.$inject = [];
    na.$inject = [];
    fb = Z < 9 ? function (b) {
        b = b.nodeName ? b : b[0];
    ...
    var kc = /[A-Z]/g, id = {full:"1.0.5", major:1, minor:0, dot:5, codeName:"flatulent-propulsion"}, Ca = L.cache = {}, Ba = L.expando = "ng-" + (new Date).getTime(), oc = 1, $b = X.document.addEventListener ? function (b, a, c) {
    ...
    }, mc = /([\:\-\_]+(.))/g, nc = /^moz([A-Z])/, va = L.prototype = {ready:function (b) {
        function a() {
            c || (c = !0, b())
        }
    ...
    n("multiple,selected,checked,disabled,readOnly,required".split(","),
        function (b) {
            Fa[y(b)] = b
        });
    var Ab = {};
    ...
    n({data:vb, inheritedData:Ea, scope:function (b) {
        return Ea(b, "$scope")
        ...
        var d =
            y(a);
        if (Fa[d])if (x(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || C).specified ? d : q; else if (x(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), b === null ? q : b
    }, prop:function (b, a, c) {
    ...
    Cb.$inject = ["$provide"];
    var Ac = /^(x[\:\-_]|data[\:\-_])/i, Gb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/, ac = /^([^\?#]*)?(\?([^#]*))?(#(.*))?$/, Hc = ac, Hb = {http:80, https:443, ftp:21};
    hb.prototype = {$$replace:!1, absUrl:Ia("$$absUrl"),
        url:function (a, c) {
            ...
            this.hash(d[5] || "", c);
            return this
        }, protocol:Ia("$$protocol"), host:Ia("$$host"), port:Ia("$$port"), path:Jb("$$path", function (a) {
    ...
    {n:"\n", f:"\u000c", r:"\r", t:"\t", v:"\u000b", "'":"'", '"':'"'}, ib = {}, Yc = X.XMLHttpRequest || function () {
        try {
    ...
    Rb.$inject = ["$locale"];
    Tb.$inject = ["$locale"];
    var Wb = ".", hd = {yyyy:N("FullYear", 4), yy:N("FullYear", 2, 0, !0), y:N("FullYear", 1), MMMM:Ka("Month"),
            MMM:Ka("Month", !0), MM:N("Month", 2, 1), M:N("Month", 1, 1), dd:N("Date", 2), d:N("Date", 1), HH:N("Hours", 2), H:N("Hours", 1), hh:N("Hours", 2, -12), h:N("Hours", 1, -12), mm:N("Minutes", 2), m:N("Minutes", 1), ss:N("Seconds", 2), s:N("Seconds", 1), EEEE:Ka("Day"), EEE:Ka("Day", !0), a:function (a, c) {
    ...
    var Qa = function (a) {
        ...
        }, kd = Qa(), ld = Qa(!0), md = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, nd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/, od = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, bc = {text:Pa, number:function (a, c, d, e, g, h) {
            Pa(a, c, d, e, g, h);
        ...
        }], Ma = "ng-valid", La = "ng-invalid", Oa = "ng-pristine", Yb = "ng-dirty", pd = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", function (a, c, d, e, g) {
            function h(a, c) {
                c = c ? "-" + Za(c, "-") : "";
        ...
        }], yd = kb("", !0), zd = kb("Odd", 0), Ad = kb("Even", 1), Bd = Q({compile:function (a, c) {
            c.$set("ngCloak", q);
    ...
    var Ed = Q(function (a, c, d) {
        ...
        }], Gd = Q({compile:function () {
            return{pre:function (a, c, d) {
                a.$eval(d.ngInit)
            }}
        }}), Hd = Q({terminal:!0, priority:1E3}), Id = ["$locale", "$interpolate", function (a, c) {
            var d = /{}/g;
            return{restrict:"EA", link:function (e, g, h) {
                var f = h.count, j = g.attr(h.$attr.when), i = h.offset || 0, k = e.$eval(j), m = {}, l = c.startSymbol(), t = c.endSymbol();
                n(k, function (a, e) {
        ...
        Jd = Q({transclude:"element", priority:1E3, terminal:!0, compile:function (a, c, d) {
            return function (a, c, h) {
                ...
                a.$watch(function (a) {
                    ...
                    for (u in m)if (m.hasOwnProperty(u))for (r = m[u]; r.length;)w =
                        r.pop(), w.element.remove(), w.scope.$destroy();
                    m = q
                })
            }
        }}), Kd = Q(function (a, c, d) {
            ...
            a.$watch(d.ngSwitch || d.on, function (j) {
                h &&
                (f.$destroy(), h.remove(), h = f = null);
                if (g = e.cases["!" + j] || e.cases["?"])a.$eval(d.change), f = a.$new(), g(f, function (a) {
                    h = a;
                    c.append(a)
                })
            })
        }}), Od = Q({transclude:"element", priority:500, require:"^ngSwitch", compile:function (a, c, d) {
            return function (a, g, h, f) {
                f.cases["!" + c.ngSwitchWhen] = d
            }
        }}), Pd = Q({transclude:"element", priority:500, require:"^ngSwitch", compile:function (a, c, d) {
            return function (a, c, h, f) {
                f.cases["?"] = d
            }
        }}), Qd = Q({controller:["$transclude", "$element", function (a, c) {
            a(function (a) {
                c.append(a)
            })
        }]}), Rd = ["$http",
                ...
                link:function (e, h, f, j) {
                    ...
                    function m(e, f, g) {
                        function h() {
                            ...
                            for (w = c.length; y < w; y++) {
                                d = c[y];
                                i = a[d];
                                if (r.length <= y)p = {element:z.clone().attr("label", d), label:i.label}, u = [p], r.push(u), f.append(p.element); else if (u = r[y], p = u[0], p.label != d)p.element.attr("label", p.label = d);
                                B = null;
                                A = 0;
                                for (x = i.length; A < x; A++)if (d = i[A], v = u[A + 1]) {
                                    ...
                                    if (v.element.selected !== d.selected)B.prop("selected",
                        ...
                        var j = c(i[2] || i[1]), k = i[4] || i[6], l = i[5], m = c(i[3] || ""),
                            n = c(i[2] ? i[1] : k), t = c(i[7]), r = [
                                [
                                    {element:f, label:""}
                                ]
                            ];
                    ...
                    if (j[1]) {
                        for (var l = j[0], t = j[1], o =
                            f.multiple, p = f.ngOptions, s = !1, v, C = u(Y.createElement("option")), z = u(Y.createElement("optgroup")), y = C.clone(), j = 0, A = h.children(), r = A.length; j < r; j++)if (A[j].value == "") {
                            v = s = A.eq(j);
                            break
                        }
                        l.init(t, s, y);
    ...
    (ca = X.jQuery) ? (u = ca, v(ca.fn, {scope:va.scope,
        controller:va.controller, injector:va.injector, inheritedData:va.inheritedData}), ab("remove", !0), ab("empty"), ab("html")) : u = L;
    Zb.element = u;
    (function (a) {
        v(a, {bootstrap:qb, copy:U, extend:v, equals:ga, element:u, forEach:n, injector:rb, noop:C, bind:Ua, toJson:da, fromJson:ob, identity:na, isUndefined:w, isDefined:x, isString:A, isFunction:H, isObject:M, isNumber:Ra, isElement:gc, isArray:B, version:id, isDate:oa, lowercase:y, uppercase:ma, callbacks:{counter:0}});
        ta = lc(X);
        try {
            ta("ngLocale")
        } catch (c) {
        ...
        ta("ng", ["ngLocale"], ["$provide", function (a) {
            a.provider("$compile", Cb).directive({a:jd, input:cc, textarea:cc, form:kd, script:Sd, select:Ud, style:Wd, option:Vd, ngBind:vd, ngBindHtmlUnsafe:xd, ngBindTemplate:wd, ngClass:yd, ngClassEven:Ad, ngClassOdd:zd, ngCsp:Dd, ngCloak:Bd, ngController:Cd, ngForm:ld, ngHide:Ld, ngInclude:Fd, ngInit:Gd, ngNonBindable:Hd, ngPluralize:Id, ngRepeat:Jd, ngShow:Kd, ngSubmit:Ed, ngStyle:Md, ngSwitch:Nd, ngSwitchWhen:Od, ngSwitchDefault:Pd, ngOptions:Td, ngView:Rd, ngTransclude:Qd, ngModel:qd, ngList:sd,
                ngChange:rd, required:dc, ngRequired:dc, ngValue:ud}).directive(lb).directive(ec);
            a.provider({$anchorScroll:uc, $browser:wc, $cacheFactory:xc, $controller:Bc, $document:Cc, $exceptionHandler:Dc, $filter:Qb, $interpolate:Ec, $http:Vc, $httpBackend:Wc, $location:Ic, $log:Jc, $parse:Nc, $route:Qc, $routeParams:Rc, $rootScope:Sc, $q:Oc, $sniffer:Tc, $templateCache:yc, $timeout:$c, $window:Uc})
        }])
    })(Zb);
    u(Y).ready(function () {
        jc(Y, qb)
